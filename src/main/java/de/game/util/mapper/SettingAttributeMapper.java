...
public class SettingAttributeMapper {
    ...
    public static SettingEnum getStartSettingForAttribute (AttributeEnum attribute) {
    ...
    public static SettingEnum getStartSettingForAttribute (String attributeKey) {
