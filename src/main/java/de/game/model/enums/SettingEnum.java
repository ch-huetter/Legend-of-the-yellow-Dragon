...
public enum SettingEnum {
    ...
    CHARACTER_START_ATTRIBUTE_VALUE_ENDURANCE("5", "Start value of the Dexterity Attribute"),
    ...
    CHARACTER_VALUE_GROWTH_PER_ENDURANCE_STAMINA("5", "Additional Health per Vitality"),
    ...
    CHARACTER_NAME_LENGTH_MAX("32", "Maximum Length for PlayerCharacterNames");
