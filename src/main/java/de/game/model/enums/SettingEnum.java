...
public enum SettingEnum {
    ...
    CHARACTER_START_ABILITY_POINTS("1", "How many Attribute Points for a Character when he gets freshly Created"),
    ...
    CHARACTER_START_ATTRIBUTE_RAGE("100", "Start Rage for a Character with Level1"),
    ...
    CHARACTER_VALUE_GROWTH_PER_LEVEL_ARMOR("25", "Addition Armor per Level"),
    CHARACTER_VALUE_GROWTH_PER_LEVEL_RESISTANCE("15", "Additional Resistance per Level"),
