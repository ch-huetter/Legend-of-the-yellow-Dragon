...
public class PlayerCharacterListSorterService {
    ...
    public List<PlayerCharacter> sortByActiveThenLevel () {
        User                  user         = userService.getLoggedInUserFromDb();
        List<PlayerCharacter> unsortedList = playerCharacterGetter.getPlayerCharacterByUser(user);
        ...
        sortedList.add(activePlayerCharacter);
