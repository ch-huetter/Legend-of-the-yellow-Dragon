...
function ArrowFancy(direction = "left", showDiamond = false, addClass = "", classArrowPrimary = "", classArrowSecondary = "", classArrowTertiary = "") {
    return (<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"
        ...
        {showDiamond === true && (<polyline style={{stroke: "rgb(0, 0, 0)"}} points="20 28 14 23 2 28 14 33 20 28"
                                            className={"leg-fancy-arrow-diamond " + classArrowTertiary}/>)}
        <path className={"leg-fancy-arrow-primary " + classArrowPrimary}
        ...
        <path style={{stroke: "rgb(0, 0, 0)"}}
              ...
              className={"leg-fancy-arrow-secondary " + classArrowSecondary}/>
        <path style={{stroke: "rgb(0, 0, 0)"}}
